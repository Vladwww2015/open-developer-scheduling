...
class Scheduling extends Extension
{
    ...
    public static function boot()
    {
        ...
        Developer::extend('scheduling', __CLASS__);
    }
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('scheduling', 'OpenDeveloper\Developer\Scheduling\SchedulingController@index')->name('scheduling-index');
            $router->post('scheduling/run', 'OpenDeveloper\Developer\Scheduling\SchedulingController@runEvent')->name('scheduling-run');
        });
    }
